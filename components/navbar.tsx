  ...
  return (
    ...
    <div className="container">
      ...
      <ul className="buy-button list-none mb-0">
        ...
        <li className="inline mb-0">
          <Link
            href="mailto:contact@electriummobility.com"
            target="_blank"
            className="btn btn-icon rounded-full bg-red-600/5 hover:bg-red-600 border-red-600/10 hover:border-red-600 text-red-600 hover:text-white"
          >
            <svg
        ...
        <ul className="navigation-menu">
          ...
          <li className="has-submenu parent-menu-item">
            ...
            <ul className="submenu">
              <li>
                <Link href="documentation-electric-bike" className="">
                  Electric Bike
                </Link>
              </li>
              <li>
                <Link href="documentation-electric-skateboard" className="">
                  Electric Skateboard
                </Link>
              </li>
              <li>
                <Link href="documentation-onewheel" className="">
                  Onewheel
                </Link>
              </li>
            </ul>
